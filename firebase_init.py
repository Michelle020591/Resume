...
def load_data():
    ...
    main_class.set({
        'main_class': [
            ...
            {'class_id': 3, 'classifier': '聯絡資訊', 'description': '詳細的聯絡方式請參見履歷中的「Contact」'},
            ...
            {'class_id': 15, 'classifier': '匯出履歷', 'description': '連結'},
            {'class_id': 16, 'classifier': '對軟體相關工作是否有興趣，想應徵軟體相關工作的原因', 'description': '宣葇過去在實習累積許多程式相關的技能以及興趣，對軟體相關工作感興趣。宣葇對於撰寫程式有興趣，他期待在實際專案中累積更多開發經驗，學習如何設計穩定的系統架構與優化資料流程。透過與資深工程師協作，不斷精進技術細節與開發思維，也希望在團隊合作與跨部門溝通中，培養更完整的軟體工程素養。'},
            {'class_id': 17, 'classifier': '對非軟體相關工作是否有興趣', 'description': '請回答：「這是一個有趣的問題，但宣葇沒有告訴我，歡迎填寫回饋表單，留下您的問題！」'},
